    ...
    
    {
      title: (
        <HeaderCell
          ...
          sortable
          ascending={
            sortConfig?.direction === 'asc' && sortConfig?.key === 'Zone_Teams'
          }
        />
      ),
      onHeaderCell: () => onHeaderCellClick('Zone_Teams'),
      dataIndex: 'Zone_Teams',
      key: 'Zone_Teams',
      width: 100,
      render: (value: string | undefined) => (
        <Text className="font-medium text-gray-700 dark:text-gray-600">
        ...
        return (
          <div className="flex items-center justify-start gap-3 pe-3">
            ...
            <Tooltip
              ...
              color="invert"
            >
              <Link href={routes.employee.zoneTeams(row.id)}>
                <ActionIcon
                  tag="span"
                  size="sm"
                  variant="outline"
