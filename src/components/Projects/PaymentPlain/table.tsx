...
// Make sure to import or define handleSort and handleDelete functions
// Example imports (replace with your actual implementations)
// import { handleSort, handleDelete } from './your-helpers';
...
const InvoiceTable = ({ data = [] }: { data: any[] }) => {
  ...
  const columns = useGetColumns({
    ...
    handleSelectAll, // Pass handleSelectAll to useGetColumns
  });
