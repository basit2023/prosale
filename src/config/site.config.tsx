...
import logoIconImg from '@public/logo/prosale-main.png';
...
export const metaObject = (
  ...
  return {
    title: title ? `${title} - ProSale` : siteConfig.title,
    description,
    openGraph: openGraph ?? {
      title: title ? `${title} - ProSale` : title,
      description,
      url: 'https://isomorphic-furyroad.vercel.app',
      siteName: 'ProSale', // https://developers.google.com/search/docs/appearance/site-names
      images: {
